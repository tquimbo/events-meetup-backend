...
#           response = HTTParty.get("https://api.seatgeek.com/2/events?geoip=#{ip_address}&range=50mi&client_id=MjExMjk0NjV8MTY0MTA5MDU5OC40MTYzNzQy")
...
module Api
  module V1
    class NearbyController < ApplicationController
      ...
      def index
        ip_address = params[:ip]
        response = HTTParty.get("https://api.seatgeek.com/2/events?geoip=#{ip_address}&range=10mi&client_id=MjExMjk0NjV8MTY0MTA5MDU5OC40MTYzNzQy")
